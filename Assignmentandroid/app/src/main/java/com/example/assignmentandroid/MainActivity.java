...
public class MainActivity extends AppCompatActivity
        implements Summary.OnFragmentInteractionListener,Description.OnFragmentInteractionListener,RestaurantTab.OnFragmentInteractionListener,HotelTab.OnFragmentInteractionListener{
    ImageView titltImg;
    @Override
